 ...
 */
/************************************************************************************/
static void DisplayInformations(json_object *jobj,
  ...
  //==============================================================================
  {
    ...
    for (std::size_t i = 0; i < attributeNames.size(); i++) {
      ...
      json_object_object_add(jobj2, name.c_str(),
  ...
  //==============================================================================
  {
    ...
    for (std::size_t i = 0; i < variableNames.size(); i++) {
      ...
      json_object_object_add(jobj3, "TypeName",
                             json_object_new_string(typeName.c_str()));
